function [Dataset] = get_data(id)
    ...
    if(id==1)
       ...
       if(id==4)
        ...
        if(id==7)
            A = importdata('QUH-Pingan_Sub.mat');
            ground_truth = importdata('QUH-Pingan_Sub_GT.mat');   
        end
        if(id==8)
            A = importdata('WHU_Hi_LongKou.mat');
            ground_truth = importdata('WHU_Hi_LongKou_gt.mat');   
        end
        %case 'KSC'
